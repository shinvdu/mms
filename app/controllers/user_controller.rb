class UserController < ApplicationController
  ...
  private
    ...
    def user_params
      params.require(:user).permit(:uid, :nicename, :role, :sex, :really_name, :birthday, :signature, :avar, :location, :self_introduction, :token,  :scret_key, :mobile, :wechat, :qq, :weibo, :twitter_id, :facebook, :website, :note)
    end
end
