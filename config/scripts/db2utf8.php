...
$link = mysql_connect("localhost","root","879650225")
    or die("unable to connect to msql server: " . msql_error());

mysql_select_db("mms", $link)
...
while ($row = mysql_fetch_array($result)){
    mysql_query("ALTER TABLE ".$row[0]." CONVERT TO CHARACTER SET utf8 COLLATE utf8_unicode_ci;");
    #Command Reference: ALTER TABLE tableName ENGINE=MyISAM
}
mysql_query("ALTER DATABASE mms CHARACTER SET utf8 COLLATE utf8_unicode_ci;");
